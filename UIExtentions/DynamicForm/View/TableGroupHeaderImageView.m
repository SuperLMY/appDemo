...
@interface TableGroupHeaderImageView()

@property (strong, nonatomic) UIView *line;

@end

@implementation TableGroupHeaderImageView
...
//        _iconView.backgroundColor = RGB(26, 91, 173);
        ...
        _iconView.image = [UIImage imageNamed:@"文件"];
...
-(instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier{
    ...
    // H 水平方向上
    NSArray *consts1 = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-15-[iconView(15)]-5-[titleLabel]-20-|" options:NSLayoutFormatAlignAllCenterY metrics:nil views:@{@"iconView":self.iconView,@"titleLabel":self.titleLabel}];
